...
print("using sam")
sam = sam_model_registry["default"](checkpoint="sam_vit_h_4b8939.pth") # adjust checkpoint path
sam.to("cuda")
...
print(f"This is the mean auc for imagenet dataset | {test_type}: ",auc_total/num_sample)
